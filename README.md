# Learning Management System
 This project was developed for Internship Management using Java Swing

## Internship Management System

>### Important Note!
>This is the last version of the Learning Management System. It's connecting to the database via JPA(Java Persistence API). So all required classes like 'User' are entities.

#### Aim of The Project and Requirements 	



This project aims to develop a Internship Management System that can be used to automate the Internship's management.
##### Requirements:
...
- Can query all information about Internship.
...
- Represents the Internship Lessons.
...
And project includes more and more specific rules.
  ...
  ### 4. UML DIAGRAM
  ![image](./assets/61618968/a894b9e8-ee88-4f26-baf5-171588fccada)

  ### 5. DATABASE MODEL DIAGRAM
  ![image](./assets/61618968/59f3b78d-466e-4b30-9bab-3cde70066c92)
